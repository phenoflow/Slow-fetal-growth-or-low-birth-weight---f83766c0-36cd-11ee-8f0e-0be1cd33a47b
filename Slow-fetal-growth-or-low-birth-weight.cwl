...
steps:
  ...
  gestational-slow-fetal-growth-or-low-birth-weight---primary:
    run: gestational-slow-fetal-growth-or-low-birth-weight---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  premature-slow-fetal-growth-or-low-birth-weight---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: gestational-slow-fetal-growth-or-low-birth-weight---primary/output
  birthweight---primary:
  ...
  gestational-slow-fetal-growth-or-low-birth-weight---secondary:
    run: gestational-slow-fetal-growth-or-low-birth-weight---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  slow-fetal-growth-or-low-birth-weight---secondary:
    run: slow-fetal-growth-or-low-birth-weight---secondary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: gestational-slow-fetal-growth-or-low-birth-weight---secondary/output
  birth---secondary:
    run: birth---secondary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: slow-fetal-growth-or-low-birth-weight---secondary/output
  output-cases:
